...
export default function FooterTop() {
  return (
    <section className="w-full bg-white pt-12 lg:pt-20 relative">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-16 relative z-10">
        {/* Left Side: Image */}
        <div className="lg:w-1/2 flex justify-center lg:justify-start relative z-20 lg:mb-2">
          <img
            src={boyImage}
            alt="Student portrait"
            className="object-cover h-[400px] lg:h-[500px] max-w-full"
            loading="lazy"
            style={{ marginBottom: "-20px" }} // Pull up the image slightly to overlap with footer
          />
        </div>
        ...
        <div className="lg:w-1/2 flex flex-col items-center lg:items-start space-y-6 text-center lg:text-left">
          {/* Heading */}
          <h1 className="text-[#0A2B7B] text-4xl lg:text-5xl font-bold leading-tight">
            Come Here. Go Places.
          </h1>
          {/* Subheading with underline */}
          <div className="relative">
            <h2 className="text-gray-700 text-lg tracking-wide">
              FROM BROOKFIELD TO THE WORLD
            </h2>
            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 lg:left-0 lg:translate-x-0 h-0.5 w-16 bg-[#E6007E]" />
          </div>
