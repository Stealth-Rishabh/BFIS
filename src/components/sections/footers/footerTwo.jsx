...
const FooterTwo = () => {
  return (
    <footer className="pt-20 bg-gradient-to-br from-black via-gray-900 to-black relative">
      <div className="container">
        <div className="grid lg:grid-cols-[300px_auto_auto_268px] sm:grid-cols-2 grid-cols-1 gap-x-7.5 gap-y-10 justify-between text-center sm:text-left">
          <SlideUp delay={2}>
            <Logo className="text-cream-foreground mx-auto sm:mx-0" />
            <div className="mt-10">
          ...
          <SlideUp delay={4}>
            ...
            <ul className="flex flex-col lg:gap-[15px] gap-2.5 lg:pt-7.5 pt-5 items-center sm:items-start">
              <li className="text-cream-foreground flex gap-4 justify-center sm:justify-start">
              ...
              <form action="#" className="lg:mt-7.5 mt-5">
                <div className="relative overflow-hidden">
                  <Input
                    ...
                    className={
                      "rounded-md bg-[#FFFFFF1A] text-cream-foreground placeholder:text-cream-foreground max-h-15 border-none"
                    }
                  />
                  <button
                    type="submit"
