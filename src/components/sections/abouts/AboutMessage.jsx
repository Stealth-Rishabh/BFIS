    ...
    <div className="p-4 sm:p-6 md:p-8">
      <div className="bg-white py-6 sm:py-8 md:py-4">
        <div className="mx-auto max-w-screen-xl px-4 md:px-8 space-y-16">
          {/* Main Heading */}
          <motion.h1
            className="text-4xl sm:text-5xl font-extrabold text-center text-red-600 font-playfair"
            initial={{ x: -100, opacity: 0 }}
            animate={controls}
          >
            <WordPullUp
              words="Leadership Message"
              className="text-4xl sm:text-5xl font-extrabold text-center text-red-600 mb-4 font-playfair"
            />
          </motion.h1>
          ...
          <div>
            <motion.h2
              className="text-2xl sm:text-3xl font-bold text-gray-800 font-playfair mb-16 text-center"
              initial={{ x: -100, opacity: 0 }}
              animate={controls}
            >
              <WordFadeIn
          ...
          <div>
            <motion.h2
              className="text-2xl sm:text-3xl font-bold text-gray-800 mb-16 text-center font-playfair"
              initial={{ x: -100, opacity: 0 }}
              animate={controls}
            >
              <WordFadeIn
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
              ...
              >
                <div className="h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg">
                  <img
                    src="https://www.bfis.in/wp-content/uploads/2024/02/IMG-20240222-WA0005-281x300.jpg"
                    loading="lazy"
              ...
              >
                ...
                <h3 className="text-center md:text-left text-xl sm:text-2xl font-bold text-gray-800">
                  Dear Parents,
                </h3>
